...
dependencies {
    implementation 'io.github.andrestubbe:fastfilewatch:0.1.0'
...
1.  📦 **[fastfilewatch-v0.1.0.jar](https://github.com/andrestubbe/fastfilewatch/releases)** (The Core Library)
